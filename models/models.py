...
class StatsAdsTagsBrowserSwap(Base):
    __tablename__ = "stats_ads_tags_browser_swap"
...
class StatsAdsTagsDateSwap(Base):
    __tablename__ = "stats_ads_tags_date_swap"
...
class StatsAdsTagsDeviceSwap(Base):
    __tablename__ = "stats_ads_tags_device_swap"
...
class StatsAdsTagsLocationSwap(Base):
    __tablename__ = "stats_ads_tags_location_swap"
...
class StatsTagsBrowserSwap(Base):
    __tablename__ = "stats_tags_browser_swap"
...
class StatsTagsDateSwap(Base):
    __tablename__ = "stats_tags_date_swap"
...
class StatsTagsDeviceSwap(Base):
    __tablename__ = "stats_tags_device_swap"
...
class StatsTagsInventoriesSwap(Base):
    __tablename__ = "stats_tags_inventories_swap"
