...
#    FROM bg_dsp4.stats_tags_inventories_by_node_hour
#    WHERE DATE={date}
#
...
#                        SUM(spent_cpc_raw) AS spent_cpc_raw,
#                        SUM(spent_cpc_landing) AS spent_cpc_landing
#    FROM stats_ads_performance_by_node_hour
#    WHERE DATE={date}
#
#    GROUP BY tag_id,
# 	   ad_id,
...
#    FROM conversions_click
#    WHERE DATE={date}
#    GROUP BY tag_id,ad_id,location1,device1,device2,DATE
# 	) t3 ON t1.tag_id=t3.tag_id
# AND t1.ad_id=t3.ad_id
# AND t1.location1=t3.location1
# AND t1.device1=t3.device1
# AND t1.device2=t3.device2
# AND t1.date=t3.date
# LEFT JOIN tags t4 ON t1.tag_id= t4.id
# ;
#     """,
#         'index': ['tag_id', 'date', 'ad_id', 'location1', 'device1', 'device2'],
